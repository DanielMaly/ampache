...
<div id="information_actions">
    <ul>
        ...
        <?php if($playlist->searchtype == 'song') {?>
            <li>
...
<form id="editplaylist" name="editplaylist" method="post"
      action="<?php echo AmpConfig::get('web_path'); ?>/smartplaylist.php?action=update_playlist&playlist_id=<?php echo $playlist->id; ?>"
...
<div>
    <?php
    $browse = new Browse();
    $browse->set_type($playlist->get_playlist_browse_representation());
